...
AI规划助手可以根据您的自然语言描述，自动生成合理的番茄钟工作计划。
...
打开文件 `src/modules/aiAssistant.js`，找到第 11 行：

```javascript
this.apiKey = 'YOUR_DEEPSEEK_API_KEY' // 开发者在这里填入API密钥
```

将 `YOUR_DEEPSEEK_API_KEY` 替换为您的实际 API Key：

```javascript
this.apiKey = 'sk-xxxxxxxxxxxxxxxxxxxxxxxx'
```
